...
import MaryIntroSection from '../MaryIntroSection/MaryIntroSection';
  ...
  return (
    ...
    <div className="w-full bg-white pt-4 px-4 md:pt-6 md:px-6 lg:pt-8 lg:px-10 pb-10">
      ...
      <section className="relative w-full min-h-[600px] bg-[#00A3B4] rounded-[40px] md:rounded-[50px] overflow-hidden p-8 md:p-16 lg:p-20 shadow-sm">
        ...
        {/* TOP HEADING: Talk to us! - 88px */}
        <h1 className="text-white font-black uppercase text-[45px] md:text-[70px] lg:text-[128px] leading-none mb-16 relative z-10">
          Talk to us!
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 relative z-10">
          ...
          {/* LEFT COLUMN: INFO */}
          <div>
            <h2 className="font-gloria text-white text-3xl md:text-4xl lg:text-5xl mb-12">
              Yook Production AS
            </h2>
        ...
        {/* BOTTOM ROW: BIG CENTERED MAP */}
        <div className="relative z-10 mt-16 md:mt-24 w-full h-[400px] md:h-[500px] lg:h-[600px] rounded-[40px] overflow-hidden shadow-2xl border-8 border-white/10">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3580.2984208744024!2d50.52372428!3d26.18696897!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e49afd0213a19d3%3A0x2f892ffe9e6f0385!2sGlobal%20Vision%20Solutions!5e0!3m2!1sen!2sin!4v1773738693537!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
